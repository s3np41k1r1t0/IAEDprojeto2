...
silent only
cd /vagrant/IAED/IAED1920/projectos/p2/bin
...
badd +67 projeto.c
badd +6 funcoes.h
badd +10 auxiliares.h
badd +25 auxiliares.c
badd +0 README-md
badd +1 jogo.c
badd +8 jogo.h
badd +9 estruturas_jogo.h
badd +77 estruturas_jogo.c
badd +0 estrututras_equipa.h
badd +31 estruturas_equipa.h
badd +14 estruturas_equipa.c
badd +0 estruturas_equipas.h
badd +194 /vagrant/IAED/IAED1920/projectos/p2/README.md
badd +0 /vagrant/IAED/IAED1920/projectos/p2/Makefile
argglobal
silent! argdel *
$argadd equipa.c
edit auxiliares.c
...
wincmd w
argglobal
if bufexists('auxiliares.h') | buffer auxiliares.h | else | edit auxiliares.h | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
nmap <buffer> ,hp <Plug>(GitGutterPreviewHunk)
...
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 100 + 95) / 191)
exe '2resize ' . ((&lines * 18 + 23) / 47)
exe 'vert 2resize ' . ((&columns * 90 + 95) / 191)
exe '3resize ' . ((&lines * 25 + 23) / 47)
exe 'vert 3resize ' . ((&columns * 90 + 95) / 191)
argglobal
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
...
wincmd w
argglobal
if bufexists('jogo.h') | buffer jogo.h | else | edit jogo.h | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
nmap <buffer> ,hp <Plug>(GitGutterPreviewHunk)
...
wincmd w
argglobal
if bufexists('equipa.c') | buffer equipa.c | else | edit equipa.c | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
nmap <buffer> ,hp <Plug>(GitGutterPreviewHunk)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 65 - ((23 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
...
wincmd w
argglobal
if bufexists('estruturas_jogo.h') | buffer estruturas_jogo.h | else | edit estruturas_jogo.h | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
nmap <buffer> ,hp <Plug>(GitGutterPreviewHunk)
...
wincmd w
argglobal
if bufexists('equipa.h') | buffer equipa.h | else | edit equipa.h | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
nmap <buffer> ,hp <Plug>(GitGutterPreviewHunk)
...
wincmd w
argglobal
if bufexists('estruturas_equipa.h') | buffer estruturas_equipa.h | else | edit estruturas_equipa.h | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
nmap <buffer> ,hp <Plug>(GitGutterPreviewHunk)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 16 - ((9 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
...
wincmd w
argglobal
if bufexists('funcoes.h') | buffer funcoes.h | else | edit funcoes.h | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
nmap <buffer> ,hp <Plug>(GitGutterPreviewHunk)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 32 - ((17 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
...
wincmd w
argglobal
if bufexists('auxiliares.c') | buffer auxiliares.c | else | edit auxiliares.c | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
nmap <buffer> ,hp <Plug>(GitGutterPreviewHunk)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 60 - ((32 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
